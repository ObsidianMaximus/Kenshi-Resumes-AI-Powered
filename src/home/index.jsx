            ...
            <div className={(theme === 'light') ? 'bg-[url("../textures/batthern.png")]' : ''}>
                <div className='h-screen flex justify-center items-center'>
                    <div className='flex flex-col gap-2'>
                        <h1 className='font-serif text-center mb-10'>Welcome to <span className={(theme === 'light') ? 'bg-gradient-to-r from-violet-400 to-indigo-600 p-2 border rounded-xl text-white text-2xl sm:text-5xl whitespace-nowrap' : 'p-2 border-2 border-white rounded-xl text-white text-2xl sm:text-5xl whitespace-nowrap'}>Kenshi Resumes</span> </h1>
                        ...
                        <Link to={isSignedIn ? '/dashboard' : '/auth/sign-in'} className='flex justify-center'>
                            <Button className={(theme === 'light') ? "my-3 w-[40%] bg-gradient-to-r from-violet-400 to-indigo-600" : 'text-white my-3 w-[40%] bg-gradient-to-r from-slate-900 to-slate-700'}>
